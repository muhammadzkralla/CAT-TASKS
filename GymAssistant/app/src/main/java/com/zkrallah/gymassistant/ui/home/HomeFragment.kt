package com.zkrallah.gymassistant.ui.home
...
import com.zkrallah.gymassistant.adapter.HomeAdapter
import com.zkrallah.gymassistant.adapter.PaymentAdapter
import com.zkrallah.gymassistant.databinding.FragmentHomeBinding
...
class HomeFragment : Fragment() {
    ...
    private fun buildHistoryAlertDialog(user: User) {
        ...
        viewModel.payments.observe(viewLifecycleOwner) { data ->
            data?.let {
                val adapter = PaymentAdapter(it.playlists as MutableList<Payment>)
